    ...
    <>
      ...
      <div className="py-12 px-4 max-w-7xl mx-auto">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
            <FaBullhorn className="mr-3 text-indigo-500" /> Mission
          </h2>
        ...
        <section className="mb-12 bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-md">
          <h2 className="text-3xl font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
            <FaEye className="mr-3 text-indigo-500" /> Vision
          </h2>
        ...
        <section>
          <h2 className="text-3xl font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
            <FaBullseye className="mr-3 text-indigo-500" /> Objectives
          </h2>
